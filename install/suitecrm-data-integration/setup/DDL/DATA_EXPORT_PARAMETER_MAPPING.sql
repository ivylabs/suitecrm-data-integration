...
INSERT INTO DATA_EXPORT_PARAMETER_MAPPING (DATA_EXPORT,PARAMETER,PARAMETER_LABEL,TRANSFORMATION,DEFAULT_VALUE) VALUES ('Opportunity Data Report','pCampaignFilter','Select Campaign','getOpportunityData','All Campaigns');
INSERT INTO DATA_EXPORT_PARAMETER_MAPPING (DATA_EXPORT,PARAMETER,PARAMETER_LABEL,TRANSFORMATION,DEFAULT_VALUE) VALUES ('Opportunity Data Report','pCampaignStatusFilter','Select Campaign Status','getOpportunityData','All Campaign Status');
INSERT INTO DATA_EXPORT_PARAMETER_MAPPING (DATA_EXPORT,PARAMETER,PARAMETER_LABEL,TRANSFORMATION,DEFAULT_VALUE) VALUES ('Opportunity Data Report','pCampaignTypeFilter','Select Campaign Type','getOpportunityData','All Campaign Types');
INSERT INTO DATA_EXPORT_PARAMETER_MAPPING (DATA_EXPORT,PARAMETER,PARAMETER_LABEL,TRANSFORMATION,DEFAULT_VALUE) VALUES ('Opportunity Data Report','pOpportunityFilter','Select Opportunity Type','getOpportunityData','All Opportunity Types');
INSERT INTO DATA_EXPORT_PARAMETER_MAPPING (DATA_EXPORT,PARAMETER,PARAMETER_LABEL,TRANSFORMATION,DEFAULT_VALUE) VALUES ('Opportunity Data Report','pOpportunityLeadSourceFilter','Select Opportunity Lead Source','getOpportunityData','All Opportunity Lead Sources');
INSERT INTO DATA_EXPORT_PARAMETER_MAPPING (DATA_EXPORT,PARAMETER,PARAMETER_LABEL,TRANSFORMATION,DEFAULT_VALUE) VALUES ('Opportunity Data Report','pOpportunitySalesStageFilter','Select Opportunity Sales Stage','getOpportunityData','All Opportunity Sales Stages');
